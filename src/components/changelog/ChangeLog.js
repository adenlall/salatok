...
function ChangeLog() {
    ...
    return (
        <>
                            ...
                            <p className="p-2 pl-0 text-base indent-8 whitespace-normal lg:w-3/4 w-full space-y-4 items-center tracking-tight text-gray-900 dark:text-white sm:text-2xl">
                                ...
                                <ul className="space-y-6 pl-6 mt-5">
                                    <li className=""> <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-cyan-600 relative inline-block">
                                        <span class="relative text-white">You Can</span>
                                    </span> stay informed on on all the Salats time on all next 5 days as you can see in image title.</li>
                                    <li className=""> <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-cyan-600 relative inline-block">
                                        <span class="relative text-white">Random</span>
                                    </span> noun of <i>"Asmaa Allah Hosna"</i> with differents language ar - en.</li>
                                    <li className=""> <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-cyan-600 relative inline-block">
                                        <span class="relative text-white">Get</span>
                                    </span> full next 7 days <i>Hijri</i> calendar.</li>
                                    <li className=""> <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-cyan-600 relative inline-block">
                                        <span class="relative text-white">More tips</span>
                                    </span> :
                                        <ul className="space-y-0 list-decimal pl-4 list-inside">
                                            <li>How much stay to the <strong>day</strong> end</li>
                                            <li>How much stay to the <strong>mounth</strong> end</li>
                                            <li>How much stay to the <strong>week</strong> end</li>
                                        </ul>
                                    </li>
                                    <li className=""> <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-cyan-600 relative inline-block">
                                        <span class="relative text-white">mounth</span>
                                    </span> expiry percent</li>
                                    <li className=""> <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-cyan-600 relative inline-block">
                                        <span class="relative text-white">Random</span>
                                    </span> quran verse with many font and language option.</li>
                                    <li className=""> <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-cyan-600 relative inline-block">
                                        <span class="relative text-white">Play</span>
                                    </span> the quran verse by many reciters <i className="text-green-500">+5</i>
                                        <ul className="space-y-0 list-decimal pl-4 list-inside">
                                            <li>Mohamed Siddiq al-Minshawi</li>
                                            <li>AbdulBaset AbdulSamad</li>
                                            <li>Sa`ud ash-Shuraym</li>
                                            <li>Hani ar-Rifai</li>
                                            <li>Mishari Rashid al-`Afasy</li>
                                        </ul>
                                    </li>
                                </ul>
                            </p>
            ...
            <div>
                <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1574082076576647" crossOrigin="anonymous"></script>
                <ins className="adsbygoogle" style={{ display: 'block' }} data-ad-format="fluid" data-ad-layout-key="-f1+5r+5a-db+57" data-ad-client="ca-pub-1574082076576647" data-ad-slot="7751548652"></ins>
