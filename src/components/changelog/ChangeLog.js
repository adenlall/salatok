        ...
        <>
            <div className='xpag p-0 m-0 flex flex-col space-y-4 items-center bg-white dark:bg-gray-900'>
                <div className="lg:w-3/4 mt-16 w-4/5 shadow-xl flex md:flex-row flex-col items-center h-80 justify-center rounded-lg dark:text-slate-100 text-gray-800" style={{ background: 'url("https://tlgur.com/d/8BOqzyxG") center / cover' }}>
                    <div className="flex flex-col h-full w-full items-center content-center rounded-lg p-4 justify-center bg-[linear-gradient(228deg, #000000ba, transparent)]">
                        ...
                        <div className="flex flex-col space-x-2">
                            ...
                            <p className="w-full space-y-6 md:space-x-6 mt-6 flex flex-wrap md:flex-row flex-col items-center tracking-tight text-gray-800 dark:text-gray-200 sm:text-2xl">
                                <p className="md:w-1/2 w-full">
                                    let's start by introduct the main features and the website concept.<br />
                                ...
                                <p className="space-y-2">
                                    ...
                                    <p><strong>Hijri</strong> & <strong>Gregorian</strong> mounth expiry percent <i>%</i></p>
                                    <p>
                                        More tips For You :
                                ...
                                <p className="space-y-3">
                                    ...
                                    <p>
                                        For the <strong>Quran</strong> section we do tha max for get a clean recitions for commun reciters, Play the random verse from many reciters <i className="text-green-500">+5</i> :
                                    </p>
                                    <i>Wait for more</i>
                                    <ul className="space-y-0 list-disc list-inside">
