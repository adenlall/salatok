            ...
            <div className="lg:w-1/2 w-full shadow-xl flex flex-col justify-center space-y-4 items-center p-4 rounded-lg bg-slate-100 dark:bg-gray-800 dark:text-slate-100 text-gray-800">
                ...
                <div className="flex items-center w-full justify-center content-center py-6 px-2 sm:py-3 sm:px-3 rounded-lg dark:bg-gray-700 bg-[linear-gradient(20deg,#67e8f9,#22d3ee)] text-slate-100">
                    ...
                    <div className="flex space-x-1 my-2">
						<button onClick={handlePlay} className="playbtn btn btn-sm text-black m-0">
						...
						<button onClick={handlePlay} className="pausebtn btn btn-sm hidden text-black m-0">
							<svg width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M8 5V19M16 5V19" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
							</svg>
						</button>
                    </div>
                    <div className="flex space-x-2 text-black w-full sm:w-1/2">
                        <div id="ct">00:00</div>
                        <input type="range" min="1" max="100" id="seekSlider" value={seek} className="range range-sm bg-white text-white mx-2" onChange={handelSeek} />
                        <div id="tt">00:00</div>
                    </div>
                    <div className='sm:flex hidden ml-2 items-center justify-center space-x-4 p-4 lg:py-0 py-[1.4em]'>
						<button onClick={mutePlayer} className="btn btn-sm mr-2">
							<svg width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <input type="range" id="change_vol" onChange={volChange} step="0.1" min="0" max="1" className="range range-sm bg-white text-white" />
                    </div>
                </div>
                <div className=''>
