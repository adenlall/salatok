    ...
    return (
        <>
            <div className="lg:w-1/2 w-full shadow-xl flex flex-col justify-center space-y-4 items-center p-4 rounded-lg bg-slate-100 dark:bg-gray-800 dark:text-slate-100 text-gray-800">
                ...
                <div className="flex items-center w-full justify-center content-center space-x-4 py-6 px-2 sm:py-3 sm:px-3 rounded-lg dark:bg-gray-700 bg-[linear-gradient(20deg,#67e8f9,#22d3ee)] text-slate-100">
                    <audio id="music_player">
                        <source id="srslp" src="" />
                    </audio>
                    <div className="flex space-x-1">
						<button onClick={handlePlay} className="playbtn btn btn-sm text-black">
						...
						<button onClick={handlePlay} className="pausebtn btn btn-sm hidden text-black">
							<svg width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='sm:flex hidden items-center justify-center space-x-4 p-4 lg:py-0 py-[1.4em]'>
						<button onClick={mutePlayer} className="btn btn-sm">
							<svg width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
