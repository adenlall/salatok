    ...
    return (
        <>
            <div className="rounded-lg shadow-lg lg:h-80 h-96 m-0 w-full" style={{ background: 'url("https://iris.ai/wp-content/uploads/2019/05/code-coder-codes-2194062-1.jpg") center / cover' }}>
                <div className=" lg:py-8 py-20 flex rounded-lg space-y-16 flex-col items-center justify-center lg:h-80 h-96  content-center dark:bg-[linear-gradient(174deg,#00000096,black)] bg-[linear-gradient(198deg,#c0fdfebd,transparent)]">
