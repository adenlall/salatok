...
function NextSalat(props) {
    ...
    return (
        <>
            <div className="lg:w-[60%] w-full shadow-xl h-auto max-h-auto lg:h-[38em] lg:max-h-[80vh] flex md:flex-row flex-col  justify-between items-center p-4 rounded-lg bg-slate-100 dark:bg-gray-800 dark:text-slate-100 text-gray-800">
                <SalatsDay />
