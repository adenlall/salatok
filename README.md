...
## this is an old version that depend on muslimsalat.com api witch may be down from to time to other. we recommend using [main branch](https://github.com/adenlall/salatok/tree/main) witch is 100% independent from ant Third-party APIs.
